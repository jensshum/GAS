...
folder = 'C:\\Users\\Owner\\Documents\\GAS\\Abrazo Adts'
    ...
    with open(f'{folder}/{file1}', 'r') as file:
        ...
        if ('PR1') in msg:
            try:
                msg = msg.replace('\n', '\r')
                data = hl7.parse(msg)
                patient_id_number = data['PID'][0][2][0][0][0]
                ...
                room = list(flatten(data['PV1'][0][3][0]))
                ...
                print("A necessary field was missing from the file.")
                
            create_script = ''' CREATE TABLE IF NOT EXISTS test2 (
                ...
                end_time varchar(20),
                preauthorization_number varchar(40),
